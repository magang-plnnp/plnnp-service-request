...
class PermintaanKendaraanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'file'               => 'required|file|mimes:pdf,doc,docx,jpg,jpeg,png,xls,xlsx,ppt,pptx',
        ]);
    ...
    public function acc(Request $request, $id)
    {
        ...
        $jenisKendaraan = $peminjaman->kendaraan->nama_kendaraan ?? '-';

        $this->sendWhatsapp($nomor,
            "Permintaan kendaraan ({$jenisKendaraan}) atas nama *{$peminjaman->nama}* telah *DITERIMA* ✅\n" .
